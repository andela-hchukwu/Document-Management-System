...
SignupPage.propTypes = {
  userSignupRequest: _react.PropTypes.func.isRequired,
  addFlashMessage: _react.PropTypes.func.isRequired,
  isUserExists: _react.PropTypes.func.isRequired
};

exports.default = (0, _reactRedux.connect)(null, { userSignupRequest: _signupAction.userSignupRequest, addFlashMessage: _flashMessages.addFlashMessage, isUserExists: _signupAction.isUserExists })(SignupPage);